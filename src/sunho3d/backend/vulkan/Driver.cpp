...
void VulkanDriver::setupPipeline() {
    createRenderPass();
    createPipeline();
    createFramebuffers();
    createCommandPool();
...
void VulkanDriver::createLogicalDevice(Window* window) {
    if (window) {
...
void VulkanDriver::createSwapChain(sunho3d::Window *window) {
...
VkExtent2D VulkanDriver::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities, Window* window) {
...
int VulkanDriver::rateDeviceSuitability(VkPhysicalDevice device) {
